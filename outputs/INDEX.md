---
STATUS: ACTIVE
LAST_UPDATED: 2026-05-17 (塩瀬メンタリング4ヶ月目標 nolla_shiose_mentoring_goals_2026-05-19.md を カテゴリ12 に追加)
...
### 0. ブランドコンセプト・事業概要（最上流・全設計の前提）

| ファイル | 目的 | 最終更新 |
|---------|------|---------|
| [nolla_brand_concept_v1.md](nolla_brand_concept_v1.md) | **【最上流】**メインコンセプト（インタラクティブエンタメプラットフォーム）/サブコンセプト（more confident and skilled）/NG語規定（療育・認知トレーニング等）/二層ブランド戦略。LP・コピー・UI文言・キャラ設計の全てがここに準拠する | 2026-05-06 |
| [nolla_business_overview_v1.md](nolla_business_overview_v1.md) | **【事業概要ベース文書】**対象/サービス/特徴(サイエンス・データ・連携・AI役割)/ビジネスモデル5本柱/競合優位性(データNW効果・スイッチングコスト・市場タイミング)。資料作成・対外説明時のベース文書 | 2026-05-13 |
...
| [nolla_benchmark_daily.md](nolla_benchmark_daily.md) | **【日次ベンチマーク追記ログ】** ベンチマーク12社＋新興スタートアップの日次更新を1ファイルに追記。新しい日付ほど上。スケジュールタスク `nolla-benchmark-daily-research` から自動更新 | 2026-05-06 |
...
| ファイル | 目的 | 最終更新 |
|---------|------|---------|
| [nolla_shiose_mentoring_goals_2026-05-19.md](nolla_shiose_mentoring_goals_2026-05-19.md) | **【塩瀬メンタリング4ヶ月目標】**5/19第1回面談持参資料。3 Goal × 3 Benchmark構造(MVP5家庭検証/京大研究者3領域監修/コアチーム種づくり)+4面談マイルストーン+塩瀬さんへの依頼ポイント+期待しないこと明示。前回4/21面談宿題(「介入」「最適化」表現見直し)反映済み | 2026-05-17 |
...
| [nolla_benchmark_companies_v4_2026-04-30.md](nolla_benchmark_companies_v4_2026-04-30.md) | **【ベンチマーク企業一覧 v4】Tier区分・採点・優先順位を全廃止し「ニューロダイバージェント向け / 定型発達向け」の2分類のみに簡略化。** ND向け7社(Jade ND/Otsimo/Dubu/Speech Blubs/AutiSpark/Smart Tales/Mightier)+定型向け5社(ABCmouse/Sago Mini/Toca Boca/Khan Academy/Lingokids新規追加)の規模指標+詳細分析リンクのみ。旧 nolla_benchmark_inheritance_ranking_2026-04-26.md は _archive/ へ | 2026-04-30 |
...
| [nolla_khan_academy_deep_analysis_2026-04-27.md](nolla_khan_academy_deep_analysis_2026-04-27.md) | **【ベンチマーク企業分析】Khan Academy 本体・Khan Academy Kids・Khanmigo の3プロダクト統合分析** Sal Khan 2004 いとこ指導→2008 501(c)(3)化→Bill Gates 2010-07 Aspen公開賞賛→Google $2M+Gates財団$1.5M(2010-09)→TED2011→College Board SAT提携2014→Duck Duck Moose買収($1)2016-08→Khan Academy Kidsローンチ2018-07→COVID 学習30M→92M分/日(3倍超)→**Khanmigoパイロット2023-03-14(GPT-4ローンチ同日)**→Microsoft提携2024-05全米教師無料→New Hampshire 全州契約2024-06→Writing Coach 2024-07→**Khanmigo K-12 学習者 40K(SY23-24)→700K(SY24-25)→100万超(SY25-26予測)**。年売上$107.3M(2023)/累計寄付$316M超/年間アクティブ1.534億学習者+700万教師+830万保護者/学習者あたり日次14分。**Mastery Learning(100%できるまで進ませない)+Knowledge Map+Energy Points/Badges**。Khanmigo=GPT-4o系/Socratic法/保護者全履歴閲覧/利用時間上限/COPPA準拠/$4月or$44年(教師無料)。**Khan Academy Kids = Kodi the Bear常駐+Journey Mode+トラックがプレゼントを運ぶ報酬+3つから1つ選ぶボックス開封+キャラ部屋段階充実+Super Simple Songs統合+完全無料/広告なし/課金なし**=NollaのUX直接転用最有力候補。**最重要発見=Khanは特別支援に正面で踏み込まない=Nollaの差別化空白地帯**。Nolla適用優先度=Kids UX直接転用★★★/Khanmigo Socratic AI=Nolla AI Companion設計テンプレ★★★/Mastery Learning=適応型難度の理論バックボーン★★★/SAT 20時間→115点エビデンス戦略=独立RCT手本★★☆ | 2026-04-27 |
| [nolla_mightier_deep_analysis_2026-04-27.md](nolla_mightier_deep_analysis_2026-04-27.md) | **【ベンチマーク企業分析】Mightier (Neuromotion Labs・米Boston / BCH発)徹底分析** 創業者Craig Lund(CEO)/Jason Kahn PhD(CSO・BCH発明者)/Trevor Stricker(ゲーム開発・Dreamcast世代)・**起源=BCH 2009年 RAGE-Control研究→2014スピンアウト→2017 Mighteorローンチ→2018 Mightierリブランド**・累計**約$29M調達**(Seed $1.2M→Seed extension $2.4M 2018/6 Slow Ventures→Series A $6.6M 2019/5 FoxKiser→**Series B $17M 2021/12/13 DigiTx+Sony Innovation Fund+PBJ ※2026-04-27 factcheckで確定**)・**累計100K+ kids / 2.5M+ games played**・価格$28-40/月+Heart sensor armband同梱・対象6-14歳(autism/ADHD/ODD/anxiety)・**FDAクリアランス無し(意図的wellness位置=EndeavorRxと対照)**・HSA/FSA対応。**査読論文4本以上**(Adolescent Psychiatry 2012初期RCT/Frontiers in Psychiatry 2021 sham-controlled RCT/Internet Interventions 2022 n=1,045商用データ大規模解析)+**Magellan Health 2020/7 ASDパイロット=45%改善 / ABA支出1%未満コスト**+GreenShield Canada家族給付。臨床監修Joseph Gonzalez-Heydrich(BCH DNP Director・Harvard准教授)を10年以上継続露出。**最重要発見**=「病院発スピンアウト→RCT→保険提携」の7-10年王道ルートの最完全事例。**Nolla示唆**=(1)国立成育/東大IRCN等との共同研究契約Phase 0で結べ(2)デバイス必須はLTV上げる代わりに獲得10倍重い→MVPはアプリ単独+将来Apple Watch連携(3)PMDA医療機器化はPhase 4以降判断、初期はwellness位置(4)Magellan型「ABA代替コスト1%で45%改善」の数値計測を初期から設計(5)臨床監修者を共著者として10年契約 | 2026-04-27 |
| [nolla_redesign_panel_2026-04-27.md](nolla_redesign_panel_2026-04-27.md) | **【Nolla 0ベース再設計 / 3人パネル討議録】** CTO（Roblox/DTx Exit）+ ゲームP（任天堂EAD/Sony WWS）+ ハーバード神経科学者（BCH/Mightier初期RCT）の3名+補助3名（小児臨床/グロースマーケ/保護者）による徹底討議。12社ベンチマーク統合の罠を回避し、**3つの普遍法則**（コア純度10年/原体験+権威+言語非依存/空白地帯）と**Toca Life World × Sago Mini × Khan Kids × Mightier(機能のみ)** のハイブリッドのみを採用。**設計原則7（10年守る）**+**プロダクト構造（Nolla World ハブ + 20-40小ワールド + 3-5体常駐キャラ + 8領域裏計測 + Mastery Learning裏 + HRV感情調整 device-less版）**+**親の成長実感4層（週次LINE / 月次NCI / 季節証明書 / 子どもからの代筆手紙）**+**ビジネスモデル4階層**（無料/Plus¥980/Family¥1,480/学校¥3,000）+**獲得経路5本**（オーガニック/B2G2C放デイ/UGC/Featured/国境越え）+**3階建てエビデンス戦略**（観察→パイロット→RCT、対象ASD+ID限定でDubu罠回避）+**Phase 0-3 反証可能性Kill Criteria**+**Y3=10M DL × 6%有料 × ¥22,500 LTV = 90億円ARR**。**取らなかった10要素**を明示してAI詰め込み罠を回避 | 2026-04-27 |
| [nolla_lingokids_email_lifecycle_analysis_2026-05-16.md](nolla_lingokids_email_lifecycle_analysis_2026-05-16.md) | **【Lingokidsメール配信分析】** トライアル登録〜解約後7日間の実受信6通(billy@mail.lingokids.com)を時系列で全文翻訳+設計ポイント抽出。**3フェーズ構造=ウェルカム(D0)→解約検知(D+2)→引き止め4通(D+3〜6: 罪悪感解消/使い方ガイド/効果データ/安全FAQ)**。**親の感情バリア4軸**(罪悪感/不安/価値検証/安全性)を起点にした価値提案・**子ども名"ゆうや"の件名/本文挿入**で自分ごと化・**1通1CTA原則**・**低圧引き止め("間違いだった?"フレーミング+解約後数日後送信)**・**権威性4種使い分け**(165M families / kidSAFE® / Oxford+NASA / 9 out of 10)。**Nolla応用=ライフサイクルメール6日6通シナリオの設計テンプレ**。注意点=送信頻度過多/絵文字過多/CTA抽象語(Nolla調整必要)。**サービス設計時のオンボーディング・離脱防止・ライフサイクル設計の必読参考資料** | 2026-05-16 |
| [nolla_lingokids_deep_analysis_2026-05-11.md](nolla_lingokids_deep_analysis_2026-05-11.md) | **【メインベンチマーク採用後アップデート版・2026-05-11】Lingokids 全方位深掘り** 2026/5/6 "Big Fun Bigger Futures" 10周年rebrand (Elliot panda ロゴ中央化・Entertainment Platform自己定義転換)・**8 Pillar Methodology全構造**(Whole Child/Engineered Motivation/Personalized/Guided Stretch/Balanced Structure/Assessment for Progress/Real-Life/Social-Family)・**3シリーズPodcast**(Stories for Kids 4-8歳/Music to Our Ears 2-5歳/Growin' Up! 5-8歳 Emily Calandrelli)・**Adventures with Baby Bot** 52x11min長尺アニメ(2023/9発表)・**Disney全タイムライン**(2025/11/11 Mickey/Frozen/Moana初回→Marvel Spider-Man→Pixar Cars 2026/3/2→Lilo&Stitch 4/6→Toy Story 4/27 10本 / 月2IP×10ゲーム / 累計250M plays 6ヶ月)・**Billy's Lab AI Studio** 2025/4 採用率20-30%/1週間prototype/2週間で数千人テスト・**完全ad-free確認** (旧版「無料層広告あり」誤り訂正、COPPA-certified 100% ad-free)・**Neurodiverse 5特性カテゴリ** 2024/3/21 launch(ASD 81/ADHD 108/Dyslexia 140 + Child Mind Institute + The Autism Café承認 + Google Play Featured)・**Parents Area 4セクション**(Curriculum/Progress Center/Community/Profile)・Plus特典7項目・Lifetime $199・多メディア化(YouTube 2.5M subs+3独立チャンネル/Podcast/Printables/Stickers/Alexa Kids/Novel Effect)・Series D $120M GenAI+多IP二段戦略・**Nolla継承候補10項目**(Special Needs IA独立化/8 Pillar Methodology自社言語化/Lessons構造化×Open-endedハイブリッド/完全ad-free×フリーミアム/Billy's Lab 4指標+20-30%/多メディア化/RCT文化/Parents Area 4セクション/長尺アニメ自社IP/10年自己定義転換)+回避4項目+未解決10項目 | 2026-05-11 |
※ 旧版 `nolla_lingokids_deep_analysis_2026-04-30.md` は `_archive/` へ移動済（2026-05-11、新版 `nolla_lingokids_deep_analysis_2026-05-11.md` に置き換え。「無料層に広告あり」記述に誤りがあり新版で訂正）
| [nolla_japan_mainstream_kids_apps_landscape_2026-04-30.md](nolla_japan_mainstream_kids_apps_landscape_2026-04-30.md) | **【日本メインストリーム実勢調査】**Sago Mini/ABCmouse/Toca Boca同等プレイヤーが日本に存在するかを実勢調査。**結論=ゼロ**。最大候補ごっこランド(キッズスター)は累計1,000万DL/売上9億円(2024)/2024年9月IPOだがSagoの1/9・Tocaの1/100規模。ワオっち2,200万DL/シンクシンク300万人150ヶ国/しまじろう+進研ゼミ会員249万人(紙+デジタル統合)。**A〜F全カテゴリ網羅+評価マトリクス+投資家トーキングテンプレ**。日本教育アプリ市場$367M(2024、IMARC)/教育産業全体2.85兆円(矢野経済)。海外3社の日本展開はToca BocaのみApp Storeに存在も上位入りなし、Sago/ABCmouseは未展開。信頼度★★★/★★☆/★☆☆/【未確認】明示。Sensor Tower/data.ai有償ダッシュボード未確認部分は明記 | 2026-04-30 |
| [nolla_japan_kids_app_market_structural_reasons_2026-04-30.md](nolla_japan_kids_app_market_structural_reasons_2026-04-30.md) | **【日本市場 構造分析】Sago Mini/ABCmouse/Toca Boca級独立キッズアプリ事業者が日本に育たない構造的理由を8観点(市場規模・課金文化・アナログ教材独占・VC資金・言語/規制・端末・行政・過去失敗事例)で分析。5大要因ランキング+投資家トーキングポイント5パターン+Nollaが構造を逆手に取る戦略6項目。0-8歳人口790万vs米国3,500万(1/4.7)/EdTech市場3,000億円vs米国数兆円/こどもちゃれんじ75万人独占/個人情報保護法16歳未満同意で米国COPPAより厳しい/GIGAスクール幼児対象外/日本VC EdTech累計米国の1/37。各データ★★★/★★☆/★☆☆/【未確認】信頼度評価 | 2026-04-30 |
| [nolla_5company_factcheck_2026-04-27.md](nolla_5company_factcheck_2026-04-27.md) | **【5社レポート統合ファクトチェック】** ABCmouse/Sago Mini/Toca Boca成長戦略追記分+Mightier+Khan Academy 計5本の独立検証。**重大訂正3件**(Mightier Series B=$17M確定 / 累計調達$29M / Spin Master買収額のSEK・USD表記揺れ整理)。最終品質スコア=Khan Academy A / ABCmouse・Sago・Toca A- / Mightier(訂正後)A-。エージェント自身の限界(WebFetch拒否・PubMed未網羅・Crunchbase非アクセス)も開示。Jade NDレベルの致命誤情報なし=エビデンス絶対主義機能 | 2026-04-27 |

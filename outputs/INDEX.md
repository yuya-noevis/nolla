...
| [nolla_competitor_matrix_2026-04-07.md](nolla_competitor_matrix_2026-04-07.md) | 国内外競合10製品の機能・価格・差別化軸マトリクス | 2026-04-07 |
...
- **ACTIVE ファイル**: 28個（+6 research docs）+ INDEX.md
- **DEPRECATED ファイル**: 59個（_archive/）
- **その他**: mockups/, .DS_Store, HTML/PNG

**最終整理日**: 2026-04-10（v4d_building_design_rules.md→_archive/移動、Galaxy惑星テーマに統一）
